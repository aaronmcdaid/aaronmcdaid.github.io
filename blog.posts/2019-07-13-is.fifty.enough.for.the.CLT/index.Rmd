...
ps =  repeatedly_draw_two_samples_and_do_a_ttest(standard_normal, 10, 1000)
...
Increasing the sample size to 50, we see that the pvalues become more uniform, showing that the thirty-to-fifty rule works in this case:
...
But that's for another post I think.
